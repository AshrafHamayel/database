 ...
 * @author MTC
 */
public class ADVERTISINGGUI1 extends javax.swing.JFrame {
Home_screen op ; 
    /**
     * Creates new form Home_screen
     */
       public ADVERTISINGGUI1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        addstore.setText("Add ADVERTISING");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "     Search by :", " ADVERTISING ID", "ADVERTISING Floor", "ADVERTISING owner" }));
        ...
        jLabel2.setText("Enter id ADVERTISING here");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 210, 190, 30));
    ...
    private void addstoreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addstoreActionPerformed
        Add_Advertising1 addad = new  Add_Advertising1();
        
          addad.setSize(570,420);
    ...
    private void sesrechActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sesrechActionPerformed
        ...
        em.getTransaction().begin();
         ...
         Query qr=em.createNamedQuery("Advertising.findAll");
         List<Advertising> allidstore=qr.getResultList();
       String nu;
     ...
     // String owner ;
      ...
      this.a1.setText("Ad owner                \t Ad Floor \t Ad PRICE  \t  Ad time      \t Ad start date \t\tAd Id  \n");
        this.a1.append("------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n ");
 
             
             
           for(Advertising ss:allidstore)
        {
            if(ss.getAdId()== num) 
            {
        AdOwner=String.valueOf(ss.getAdOwner());
        AdFloor=String.valueOf(ss.getAdFloor().getFloorId());
         AdPrice=String.valueOf(ss.getAdPrice());
        
          AdTime=String.valueOf(ss.getAdTime());
           AdStartDate=String.valueOf(ss.getAdStartDate());
            adf=AdStartDate.split(" ");
            AdId=String.valueOf(ss.getAdId());
            
        
        this.a1.append(AdOwner +"\t      "+AdFloor+"\t    "+AdPrice+"     \t "+ AdTime+"\t"+AdStartDate+"\t\t"+ AdId+ "\n");
      ...
      this.a1.setText("Ad owner                \t Ad Floor \t Ad PRICE  \t  Ad time      \t Ad start date \t\tAd Id  \n");
        this.a1.append("------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n ");
           ...
           for(Advertising ss:allidstore)
        {
            if(ss.getAdFloor().getFloorId()== num) 
            {
         AdOwner=String.valueOf(ss.getAdOwner());
        AdFloor=String.valueOf(ss.getAdFloor().getFloorId());
         AdPrice=String.valueOf(ss.getAdPrice());
    ...
    private void showallActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showallActionPerformed
     ...
     Query qr=em.createNamedQuery("Advertising.findAll");
      List<Advertising> allAd=qr.getResultList();
   ...
   return;
    ...
    private void editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionPerformed
              ...
              edit_ad1 editad = new  edit_ad1();
        
                      editad.setSize(475,465);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ADVERTISINGGUI1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ADVERTISINGGUI1().setVisible(true);
            }
        });
    }
