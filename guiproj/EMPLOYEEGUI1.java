 ...
 * @author MTC
 */
public class EMPLOYEEGUI1 extends javax.swing.JFrame {
Home_screen op ; 
    /**
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "     Search by :", " EMPLOYEE  ID", "   Floor Number", "EMPLOYEE Name ", " " }));
        ...
        jLabel2.setText("Enter id EMPLOYEE here");
        ...
        jPanel3.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(271, 0, 410, 61));
    ...
    private void addstoreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addstoreActionPerformed
      Add_EMPLOYEE1 EMPLOY = new  Add_EMPLOYEE1();
        
        
          EMPLOY.setSize(890,375);
    ...
    private void sesrechActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sesrechActionPerformed
        ...
        em.getTransaction().begin();
         ...
         List<Employee> allEmployee=qr.getResultList();
       String nu;
      ...
      int num; 
        ...
        this.a1.setText("Employee NAME  \t Employee ID \t    Employee PHONE  \t Employee Salary \t SEX         \t  ADDRESS   \t\tFloor Number \n");
        this.a1.append("------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n ");
       ...
       EMPLOYEE_NAME=String.valueOf(ss.getEmployeeName());
        EMPLOYEEID=String.valueOf(ss.getEmployeeId());
               EMPLOYEE_PHONE=String.valueOf(ss.getEmployeePhone());
            EMPLOYEE_SALARY=String.valueOf(ss.getEmployeeSalary());
             SEX=String.valueOf(ss.getEmployeeSex());
             ADDRESS=String.valueOf(ss.getEmployeeAddress());
           
             Floor_number=String.valueOf(ss.getFloorNumber().getFloorId());
            
         this.a1.append( EMPLOYEE_NAME +"\t     \t"+ EMPLOYEEID+"\t      "+ EMPLOYEE_PHONE+ "\t\t    "+ EMPLOYEE_SALARY+ "\t   \t"+SEX+"\t   "+ADDRESS+"\t\t           "+Floor_number+"\n");
       ...
       this.a1.setText("Employee NAME  \t Employee ID \t    Employee PHONE  \t Employee Salary \t SEX         \t  ADDRESS   \t\tFloor Number \n");
        this.a1.append("------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n ");
           ...
           for(Employee ss:allEmployee)
        {
            if(ss.getFloorNumber().getFloorId()== num) 
            {
        EMPLOYEE_NAME=String.valueOf(ss.getEmployeeName());
        EMPLOYEEID=String.valueOf(ss.getEmployeeId());
               EMPLOYEE_PHONE=String.valueOf(ss.getEmployeePhone());
        ...
        this.a1.append("------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n ");
           ...
           for(Employee ss:allEmployee)
        {
            if(ss.getEmployeeName().contains(nu)) 
            {
   ...
   return;
    ...
    private void editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionPerformed
              ...
              edit_EMPLOYEE1 editEMPLOYEE = new   edit_EMPLOYEE1();
        
                      editEMPLOYEE.setSize(855,435);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EMPLOYEEGUI1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EMPLOYEEGUI1().setVisible(true);
            }
        });
    }
