...
Home_screen op ; 
    ...
    private void initComponents() {
        ...
        addstore.setText("Add new store");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "     Search by :", " Store ID", "Namber of Floor" }));
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 210, 130, 30));
    ...
    private void sesrechActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sesrechActionPerformed
        ...
        em.getTransaction().begin();
         ...
         Query qr=em.createNamedQuery("Stores.findAll");
         List<Stores> allidstore=qr.getResultList();
       String nu;
      ...
      int num;  
        ...
        num=Integer.parseInt(nu);   
         ...
         this.a1.setText("Id Store \t Store Floor \t      STORE PRICE PER YEAR \t     STORE PRICE TO OWNER \n");
         this.a1.append("------------------------------------------------------------------------------------------------------------------------------------\n ");
 
             
             
           for(Stores ss:allidstore)
        {
            if(ss.getIdStore()== num) 
            {
         IdStore=String.valueOf(ss.getIdStore());
        floorStore=String.valueOf(ss.getStoreFloor().getFloorId());
        yearStore=String.valueOf(ss.getStorePricePerYear());
        ownerStore=String.valueOf(ss.getStorePriceToOwn());
        
        this.a1.append(IdStore +"\t        "+ floorStore+"\t\t"+yearStore+"\t\t"+ownerStore+"\n");
        this.a1.append("------------------------------------------------------------------------------------------------------------------------------------\n ");
            }
         ...
         this.a1.append("------------------------------------------------------------------------------------------------------------------------------------\n ");
           ...
           for(Stores ss:allidstore)
        {
            if(ss.getStoreFloor().getFloorId()== num) 
            {
         IdStore=String.valueOf(ss.getIdStore());
        floorStore=String.valueOf(ss.getStoreFloor().getFloorId());
        yearStore=String.valueOf(ss.getStorePricePerYear());
...
input=new FileInputStream(new File("Tree.jrxml"));
jasperDesign=JRXmlLoader.load(input);
jasperReport=JasperCompileManager.compileReport(jasperDesign);
jasperPrint=JasperFillManager.fillReport(jasperReport, null, con);
output= new FileOutputStream(new File("Total annual stores rent for each Floor.pdf"));
...
input.close();
 JOptionPane.showMessageDialog(this, "Report ready, View PDF file");           
    ...
    private void showallActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showallActionPerformed
     ...
     Query qr=em.createNamedQuery("Stores.findAll");
      List<Stores> allstore=qr.getResultList();
   ...
   return;
    ...
    private void editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionPerformed
              ...
              edit_store editstore = new  edit_store();
        
                      editstore.setSize(436,400);
